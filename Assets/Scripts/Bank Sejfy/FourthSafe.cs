...
public class FourthSafe : MonoBehaviour
{
    ...
    private void Update()
    {
        if (!isOpened && canOpen && CorrectFourthSafeNote.knowCodeToSafeFourth && Input.GetKeyDown(KeyCode.E))
        {
        ...
        else if (!isOpened && canOpen && !CorrectFourthSafeNote.knowCodeToSafeFourth && Input.GetKeyDown(KeyCode.E))
        {

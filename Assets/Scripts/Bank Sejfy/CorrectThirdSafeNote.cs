...
public class CorrectThirdSafeNote : MonoBehaviour
{
    ...
    [SerializeField] private ThirdSentanceNote goodSentanceNote;
    
    public static bool knowCodeToSafeThree = false;

    private void Awake()
    {
        knowCodeToSafeThree = false;
    }
...
[System.Serializable]
public class ThirdSentanceNote
{
    [TextArea(1, 5)]

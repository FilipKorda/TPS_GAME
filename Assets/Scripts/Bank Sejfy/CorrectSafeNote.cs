...
public class CorrectSafeNote : MonoBehaviour
{
    ...
    [SerializeField] private GoodSentanceNote goodSentanceNote;

    public static bool knowCodeToSafeOne = false;

    private void Awake()
    {
        knowCodeToSafeOne = false;
    }

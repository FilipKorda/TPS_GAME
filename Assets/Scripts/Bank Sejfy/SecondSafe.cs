...
public class SecondSafe : MonoBehaviour
{
    ...
    private void Update()
    {
        if (!isOpened && canOpen && CorrectSecondSafeNote.knowCodeToSafeTwo && Input.GetKeyDown(KeyCode.E))
        {
        ...
        else if (!isOpened && canOpen && !CorrectSecondSafeNote.knowCodeToSafeTwo && Input.GetKeyDown(KeyCode.E))
        {

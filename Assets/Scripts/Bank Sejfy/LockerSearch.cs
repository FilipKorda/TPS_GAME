...
public class LockerSearch : MonoBehaviour
{
    ...
    [SerializeField] private GameObject noteObjectToDrop;
    ...
    {
        if (noteObjectToDrop == null)
        {
            return;
        }
        GameObject droppedObject = Instantiate(noteObjectToDrop, transform.position, Quaternion.identity);

...
public class CorrectFourthSafeNote : MonoBehaviour
{
    ...
    [SerializeField] private FourthSentanceNote goodSentanceNote;

    public static bool knowCodeToSafeFourth = false;

    private void Awake()
    {
        knowCodeToSafeFourth = false;
    }
...
[System.Serializable]
public class FourthSentanceNote
{
    [TextArea(1, 5)]
